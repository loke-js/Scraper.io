...
export default function ExecutionTable({workflowId,initialData}:{workflowId:string,initialData:InitialDataType}) {
                            ...
                            >
                                ...
                                <TableCell>
                                    <div className="flex flex-col">
                                        ...
                                        <div className="text-muted-foreground mx-5 text-xs">{duration}</div>
                                    </div>
                                </TableCell>
                                <TableCell>
                                    <div className="flex flex-col">
                                        ...
                                        <div className="text-muted-foreground mx-5 text-xs">Credits</div>
                                    </div>
                                </TableCell>
